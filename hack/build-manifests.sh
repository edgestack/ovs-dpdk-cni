...
export OVS_DPDK_CNI_PLUGIN_IMAGE_REPO=${OVS_CNI_PLUGIN_IMAGE_REPO:-registry.gitlab.com/sonaproject}
export OVS_DPDK_CNI_PLUGIN_IMAGE_NAME=${OVS_CNI_PLUGIN_IMAGE_NAME:-ovs-dpdk-cni-plugin}
export OVS_DPDK_CNI_PLUGIN_IMAGE_VERSION=${OVS_CNI_PLUGIN_IMAGE_VERSION:-latest}
export OVS_DPDK_CNI_PLUGIN_IMAGE_PULL_POLICY=${OVS_CNI_PLUGIN_IMAGE_PULL_POLICY:-IfNotPresent}
